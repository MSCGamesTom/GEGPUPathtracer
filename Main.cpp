// Game.cpp
// Main entry point for the GE GPU Pathtracer application.
// This file sets up the window, graphics core, shaders, scene, camera, and handles input
// to update and render the scene continuously.
